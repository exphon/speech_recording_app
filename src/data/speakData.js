 ...
 * ========================================
 * This file (speakData.js) is currently not in use.
 * All exports and functionality are commented out.
 * 
 * 이 파일(speakData.js)은 현재 사용되지 않습니다.
 * 모든 export와 기능이 주석 처리되어 있습니다.
 * 
 * Date: 2025-11-08
 * ======================================== */
...
// 말하기 녹음 데이터 (1~6등급, 멀티 세트 지원)
// - 등급별 과제 유형과 준비/대답 시간을 정의합니다.
// - 발음 녹음처럼 여러 세트로 구성되며, 참가자에게 균등하게 분배할 수 있도록 헬퍼를 제공합니다.
...
// Placeholder exports to prevent build errors if this file is referenced
export default {};
export const gradeMeta = {};
export const speakSets = [];
export const getAssignedSpeakSet = () => null;
export const getSpeakSetById = () => null;
export const getDefaultSpeakSet = () => null;
export const getGradesForPronLevel = () => [];
export const getSpeakingQuestionsForLevel = () => [];
